...
% Create a new point cloud object ptt using the point cloud positions after mean shift
% ptt1 = pointCloud(z);
ptt2 = pointCloud(zz);
...
pcwrite(ptt2, 'ProMeanShift_smoothed.ply');
fprintf('Improved MeanShift smoothing completed. The result has been saved as ProMeanShift_smoothed.ply\n');